...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wgefa8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wgefa8.containers.anotherwebservice.com/
...
```
git clone git@github.com:ihaboxy95/container-wgefa8.git
cd container-wgefa8
```
...
```
docker attach container-wgefa8
```
